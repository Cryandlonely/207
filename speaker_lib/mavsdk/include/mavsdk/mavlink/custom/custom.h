...
#define MAVLINK_CUSTOM_XML_HASH 8499827800889075698
...
/** @brief Component ids (values) for the different types and instances of onboard hardware/software that might make up a MAVLink system. */
#ifndef HAVE_ENUM_MAV_USER_COMPONENT
#define HAVE_ENUM_MAV_USER_COMPONENT
typedef enum MAV_USER_COMPONENT
{
   MAV_COMP_ID_CUSTOM_GIMBAL=25, /* Custom Gimbal,#1~3. | */
   MAV_COMP_ID_CUSTOM_CAMERA=28, /* Custom Camera,#1~3. | */
   MAV_COMP_ID_CUSTOM_MOTOR=31, /* Custom Motor,#1~10. | */
   MAV_COMP_ID_SPEAKER=41, /* Speaker,#1~3. | */
   MAV_COMP_ID_SKYLINK=44, /* SKYLINK,#1~3. | */
   MAV_COMP_ID_LIGHT=47, /* LIGHT,#1~3. | */
   MAV_COMP_ID_PLANE=50, /* PLANE,#1,only one. | */
   MAV_COMP_ID_CUSTOM_UNITREE_DOG=51, /* Custom Unitree Dog,only one. | */
   MAV_USER_COMPONENT_ENUM_END=52, /*  | */
} MAV_USER_COMPONENT;
#endif

/** @brief Mode of play audio. */
#ifndef HAVE_ENUM_SPEAKER_PLAY_AUDIO_MODE
#define HAVE_ENUM_SPEAKER_PLAY_AUDIO_MODE
typedef enum SPEAKER_PLAY_AUDIO_MODE
{
   NONE_MODE=0, /* None. | */
   SINGLE_PLAY=1, /* Play a audio once. | */
   LOOP_PLAY=2, /* Loop play. | */
   REAL_TIME_SPEAK=3, /* Real time voice. | */
   SPEAKER_PLAY_AUDIO_MODE_ENUM_END=4, /*  | */
} SPEAKER_PLAY_AUDIO_MODE;
#endif

/** @brief Status of audio play. */
#ifndef HAVE_ENUM_SPEAKER_PLAY_AUDIO_STATUS
#define HAVE_ENUM_SPEAKER_PLAY_AUDIO_STATUS
typedef enum SPEAKER_PLAY_AUDIO_STATUS
{
   IDLE=0, /* Idle status. | */
   PLAYING=1, /* Play status. | */
   SPEAKER_PLAY_AUDIO_STATUS_ENUM_END=2, /*  | */
} SPEAKER_PLAY_AUDIO_STATUS;
#endif

/** @brief Type of update audio file. */
#ifndef HAVE_ENUM_SPEAKER_UPDATE_AUDIO_FILE_TYPE
#define HAVE_ENUM_SPEAKER_UPDATE_AUDIO_FILE_TYPE
typedef enum SPEAKER_UPDATE_AUDIO_FILE_TYPE
{
   AUDIO_FILE_NONE_TYPE=0, /* None. | */
   AUDIO_FILE_ADD=1, /* Add a audio file. | */
   AUDIO_FILE_REMOVE=2, /* Delete a audio file. | */
   AUDIO_FILE_RENAME=3, /* Rename a audio file. | */
   SPEAKER_UPDATE_AUDIO_FILE_TYPE_ENUM_END=4, /*  | */
} SPEAKER_UPDATE_AUDIO_FILE_TYPE;
#endif

/** @brief Mode of speaker light. */
#ifndef HAVE_ENUM_SPEAKER_LIGHT_MODE
#define HAVE_ENUM_SPEAKER_LIGHT_MODE
typedef enum SPEAKER_LIGHT_MODE
{
   MODE0=0, /* None light mode. | */
   MODE1=1, /* Mode 1. | */
   MODE2=2, /* Mode 2. | */
   MODE3=3, /* Mode 3. | */
   MODE4=4, /* Mode 4. | */
   SPEAKER_LIGHT_MODE_ENUM_END=5, /*  | */
} SPEAKER_LIGHT_MODE;
#endif

/** @brief On/off of speaker light. */
#ifndef HAVE_ENUM_SPEAKER_LIGHT_ON_OFF
#define HAVE_ENUM_SPEAKER_LIGHT_ON_OFF
typedef enum SPEAKER_LIGHT_ON_OFF
{
   OFF=0, /* Off. | */
   ON=1, /* On. | */
   SPEAKER_LIGHT_ON_OFF_ENUM_END=2, /*  | */
} SPEAKER_LIGHT_ON_OFF;
#endif

/** @brief On/off of speaker light. */
#ifndef HAVE_ENUM_SPEAKER_FILE_OPERATION_PERMISSION
#define HAVE_ENUM_SPEAKER_FILE_OPERATION_PERMISSION
typedef enum SPEAKER_FILE_OPERATION_PERMISSION
{
   RELEASE=0, /* Off. | */
   GET=1, /* On. | */
   SPEAKER_FILE_OPERATION_PERMISSION_ENUM_END=2, /*  | */
} SPEAKER_FILE_OPERATION_PERMISSION;
#endif

/** @brief operation type of multi connection. */
#ifndef HAVE_ENUM_SPEAKER_MULTI_CONNECTION_OPERATION_TYPE
#define HAVE_ENUM_SPEAKER_MULTI_CONNECTION_OPERATION_TYPE
typedef enum SPEAKER_MULTI_CONNECTION_OPERATION_TYPE
{
   OPEN_CONNECTION=0, /* Open. | */
   CLOSE_CONNECTION=1, /* Close. | */
   REMOVE_CONNECTION=2, /* Remove. | */
   ADD_CONNECTION=3, /* Add. | */
   QUERY_CONNECTION_AMOUNT=4, /* Query connection amount. | */
   QUERY_CONNECTION_ID=5, /* Query connection id. | */
   QUERY_CONNECTION_STATUS=6, /* Query status. | */
   SPEAKER_MULTI_CONNECTION_OPERATION_TYPE_ENUM_END=7, /*  | */
} SPEAKER_MULTI_CONNECTION_OPERATION_TYPE;
#endif

/** @brief Start/Stop real time voice. */
#ifndef HAVE_ENUM_SPEAKER_REAL_TIME_VOICE_OPERATION
#define HAVE_ENUM_SPEAKER_REAL_TIME_VOICE_OPERATION
typedef enum SPEAKER_REAL_TIME_VOICE_OPERATION
{
   START_REAL_TIME_LISTEN=0, /* Off. | */
   STOP_REAL_TIME_LISTEN=1, /* Off. | */
   START_REAL_TIME_SPEAK=2, /* Off. | */
   STOP_REAL_TIME_SPEAK=3, /* On. | */
   SPEAKER_REAL_TIME_VOICE_OPERATION_ENUM_END=4, /*  | */
} SPEAKER_REAL_TIME_VOICE_OPERATION;
#endif

/** @brief Status of real time voice. */
#ifndef HAVE_ENUM_SPEAKER_REAL_TIME_VOICE_STATUS
#define HAVE_ENUM_SPEAKER_REAL_TIME_VOICE_STATUS
typedef enum SPEAKER_REAL_TIME_VOICE_STATUS
{
   VOICE_OFF=0, /* Off. | */
   VOIDE_ON=1, /* On. | */
   VOICE_ERROR=2, /* Error. | */
   SPEAKER_REAL_TIME_VOICE_STATUS_ENUM_END=3, /*  | */
} SPEAKER_REAL_TIME_VOICE_STATUS;
#endif

/** @brief Indicate the switch status */
#ifndef HAVE_ENUM_MAV_TK_STATUS
#define HAVE_ENUM_MAV_TK_STATUS
typedef enum MAV_TK_STATUS
{
   TK_STATUS_OFF=0, /* Off | */
   TK_STATUS_ON=1, /* On | */
   MAV_TK_STATUS_ENUM_END=2, /*  | */
} MAV_TK_STATUS;
#endif

/** @brief Indicate the image flip status */
#ifndef HAVE_ENUM_MAV_TK_IMAGE_FLIP
#define HAVE_ENUM_MAV_TK_IMAGE_FLIP
typedef enum MAV_TK_IMAGE_FLIP
{
   TK_HORIZONTAL_CLOCKWISE=0, /* Horizontal clockwise flip | */
   TK_HORIZONTAL_COUNTER_CLOCKWISE=1, /* Horizontal counter-clockwise flip | */
   TK_VERTICAL_CLOCKWISE=2, /* Vertical clockwise flip | */
   TK_VERTICAL_COUNTER_CLOCKWISE=3, /* Vertical counter-clockwise flip | */
   MAV_TK_IMAGE_FLIP_ENUM_END=4, /*  | */
} MAV_TK_IMAGE_FLIP;
#endif

/** @brief Indicate the infrared temperature measurement flag */
#ifndef HAVE_ENUM_MAV_TK_TEMPERATURE_FLAG
#define HAVE_ENUM_MAV_TK_TEMPERATURE_FLAG
typedef enum MAV_TK_TEMPERATURE_FLAG
{
   TK_TEMP_MEASUREMENT_STATUS=1, /* Infrared temperature measurement status | */
   TK_TEMP_MEASUREMENT_LEVEL=2, /* Infrared temperature measurement level | */
   MAV_TK_TEMPERATURE_FLAG_ENUM_END=3, /*  | */
} MAV_TK_TEMPERATURE_FLAG;
#endif

/** @brief Indicate the infrared temperature measurement level */
#ifndef HAVE_ENUM_MAV_TK_TEMPERATURE_LEVEL
#define HAVE_ENUM_MAV_TK_TEMPERATURE_LEVEL
typedef enum MAV_TK_TEMPERATURE_LEVEL
{
   TK_TEMP_LEVEL_1=0, /* Level 1 | */
   TK_TEMP_LEVEL_2=1, /* Level 2 | */
   TK_TEMP_LEVEL_3=2, /* Level 3 | */
   TK_TEMP_LEVEL_4=3, /* Level 4 | */
   MAV_TK_TEMPERATURE_LEVEL_ENUM_END=4, /*  | */
} MAV_TK_TEMPERATURE_LEVEL;
#endif

/** @brief Indicate the laser range finder flag */
#ifndef HAVE_ENUM_MAV_TK_LASER_RANGE_FINDER
#define HAVE_ENUM_MAV_TK_LASER_RANGE_FINDER
typedef enum MAV_TK_LASER_RANGE_FINDER
{
   TK_SINGLE_DISTANCE_MEASUREMENT=0, /* Single distance measurement | */
   TK_CONTINUOUS_DISTANCE_MEASUREMENT=1, /* Continuous distance measurement | */
   TK_STOP_MEASUREMENT=2, /* Stop distance measurement | */
   MAV_TK_LASER_RANGE_FINDER_ENUM_END=3, /*  | */
} MAV_TK_LASER_RANGE_FINDER;
#endif

/** @brief Status control */
#ifndef HAVE_ENUM_FILL_LIGHT_FLAG
#define HAVE_ENUM_FILL_LIGHT_FLAG
typedef enum FILL_LIGHT_FLAG
{
   TK_FILL_LIGHT_STATUS=1, /* Status setting | */
   TK_FILL_LIGHT_BRIGHTNESS=2, /* Brightness setting | */
   TK_FILL_LIGHT_SPOT=4, /* Light spot control | */
   FILL_LIGHT_FLAG_ENUM_END=5, /*  | */
} FILL_LIGHT_FLAG;
#endif

/** @brief Indicate the PIP mode */
#ifndef HAVE_ENUM_PIP_MODE
#define HAVE_ENUM_PIP_MODE
typedef enum PIP_MODE
{
   PIP_MODE_NULL=0, /* Null | */
   PIP_MAIN_WHITE_LIGHT=1, /* Main white light mode | */
   PIP_MAIN_THERMAL=2, /* Main thermal imaging mode | */
   PIP_MAIN_WHITE_SUB_THERMAL=3, /* Main white light + Secondary thermal imaging mode | */
   PIP_MAIN_THERMAL_SUB_WHITE=4, /* Main thermal + Secondary white light mode | */
   PIP_MAIN_WIDE_ANGLE=5, /* Main wide-angle mode | */
   PIP_MAIN_WHITE_SUB_WIDE=6, /* Main white light + Secondary wide-angle mode | */
   PIP_MAIN_WIDE_SUB_WHITE=7, /* Main wide-angle + Secondary white light mode | */
   PIP_MODE_ENUM_END=8, /*  | */
} PIP_MODE;
#endif

/** @brief Indicate the motor status */
#ifndef HAVE_ENUM_MOTOR_STATUS
#define HAVE_ENUM_MOTOR_STATUS
typedef enum MOTOR_STATUS
{
   MOTOR_STATUS_ON=0, /* On | */
   MOTOR_STATUS_OFF=1, /* Off | */
   MOTOR_STATUS_ENUM_END=2, /*  | */
} MOTOR_STATUS;
#endif

/** @brief Clutch status */
#ifndef HAVE_ENUM_TK_CLUTCH_STATUS
#define HAVE_ENUM_TK_CLUTCH_STATUS
typedef enum TK_CLUTCH_STATUS
{
   CLUTCH_STATUS_ON=0, /* On | */
   CLUTCH_STATUS_OFF=1, /* Off | */
   TK_CLUTCH_STATUS_ENUM_END=2, /*  | */
} TK_CLUTCH_STATUS;
#endif

/** @brief data collection status */
#ifndef HAVE_ENUM_TK_DATA_COLLECTION_STATUS
#define HAVE_ENUM_TK_DATA_COLLECTION_STATUS
typedef enum TK_DATA_COLLECTION_STATUS
{
   DATA_COLLECTION_ON=0, /* On | */
   DATA_COLLECTION_OFF=1, /* Off | */
   TK_DATA_COLLECTION_STATUS_ENUM_END=2, /*  | */
} TK_DATA_COLLECTION_STATUS;
#endif

/** @brief Data collection frequency */
#ifndef HAVE_ENUM_TK_DATA_COLLECTION_FREQUENCY
#define HAVE_ENUM_TK_DATA_COLLECTION_FREQUENCY
typedef enum TK_DATA_COLLECTION_FREQUENCY
{
   DATA_COLLECTION_FREQUENCY_50HZ=0, /* 50 Hz | */
   DATA_COLLECTION_FREQUENCY_100HZ=1, /* 100 Hz | */
   DATA_COLLECTION_FREQUENCY_200HZ=2, /* 200 Hz | */
   DATA_COLLECTION_FREQUENCY_500HZ=3, /* 500 Hz | */
   DATA_COLLECTION_FREQUENCY_1000HZ=4, /* 1000 Hz | */
   TK_DATA_COLLECTION_FREQUENCY_ENUM_END=5, /*  | */
} TK_DATA_COLLECTION_FREQUENCY;
#endif

/** @brief Indicate the motor error status */
#ifndef HAVE_ENUM_MOTOR_ERROR_STATUS
#define HAVE_ENUM_MOTOR_ERROR_STATUS
typedef enum MOTOR_ERROR_STATUS
{
   MOTOR_LOW_VOLTAGE_STATE=1, /* Low voltage status, 0:normal, 1:low voltage protection | */
   MOTOR_HIGH_VOLTAGE_STATE=2, /* High voltage status, 0:normal, 1:high voltage protection | */
   MOTOR_DRIVER_TEMPERATURE_STATE=4, /* Driver temperature status, 0:normal, 1:driver overheating | */
   MOTOR_TEMPERATURE_STATE=8, /* Motor temperature status, 0:normal, 1:motor overheating | */
   MOTOR_CURRENT_STATE=16, /* Motor current status, 0:normal, 1:motor overcurrent | */
   MOTOR_SHORT_CIRCUIT_STATE=32, /* Motor short circuit status, 0:normal, 1:motor short circuit | */
   MOTOR_STALL_STATE=64, /* Motor stall status, 0:normal, 1:motor stall | */
   MOTOR_INPUT_SIGNAL_STATE=128, /* Input signal status, 0:normal, 1:input signal loss timeout | */
   MOTOR_ERROR_STATUS_ENUM_END=129, /*  | */
} MOTOR_ERROR_STATUS;
#endif

/** @brief Set motor rotation direction. */
#ifndef HAVE_ENUM_MOTOR_DIRECTION_CONTROL
#define HAVE_ENUM_MOTOR_DIRECTION_CONTROL
typedef enum MOTOR_DIRECTION_CONTROL
{
   MOTOR_CW=1, /* Motor clockwise. | */
   MOTOR_CCW=2, /* Motor counterclockwise. | */
   MOTOR_DIRECTION_CONTROL_ENUM_END=3, /*  | */
} MOTOR_DIRECTION_CONTROL;
#endif

/** @brief Motor parameter control table. */
#ifndef HAVE_ENUM_MOTOR_PARAMETER_CONTROL_TABLE
#define HAVE_ENUM_MOTOR_PARAMETER_CONTROL_TABLE
typedef enum MOTOR_PARAMETER_CONTROL_TABLE
{
   ANGLE_PID=1, /* Angle PID, contains 3 parameters, each parameter is float type.. | */
   VELOCITY_PID=2, /*  Velocity PID, contains 3 parameters, each parameter is float type. | */
   CURRENT_PID=3, /*  Current PID, contains 3 parameters, each parameter is uint16_t type. | */
   MAX_TORQUE_CURRENT=4, /*  Maximum torque current, contains 1 parameter of int16_t type. | */
   MAX_SPEED=5, /*  Maximum speed, contains 1 parameter of int32_t type.  | */
   ANGLE_LIMIT=6, /* Angle limit, contains 1 parameter of int32_t type. | */
   CURRENT_SLOPE=7, /*  Current slope, contains 1 parameter of int32_t type. | */
   SPEED_SLOPE=8, /* Speed slope, contains 1 parameter of int32_t type.  | */
   MOTOR_CALIBRATION=9, /* motor calibration ,line sequential,endoer type,direction wait.  | */
   MOTOR_PARAMETER_CONTROL_TABLE_ENUM_END=10, /*  | */
} MOTOR_PARAMETER_CONTROL_TABLE;
#endif

/** @brief Motor line reverse control. */
#ifndef HAVE_ENUM_MOTOR_LINE_REVERSE_ENUM
#define HAVE_ENUM_MOTOR_LINE_REVERSE_ENUM
typedef enum MOTOR_LINE_REVERSE_ENUM
{
   MOTOR_LINE_NOT_REVERSE=0, /* Motor line not reverse. | */
   MOTOR_LINE_REVERSE=1, /* Motor line reverse. | */
   MOTOR_LINE_REVERSE_ENUM_ENUM_END=2, /*  | */
} MOTOR_LINE_REVERSE_ENUM;
#endif

/** @brief Motor angle reverse control. */
#ifndef HAVE_ENUM_MOTOR_ANGLE_REVERSE_ENUM
#define HAVE_ENUM_MOTOR_ANGLE_REVERSE_ENUM
typedef enum MOTOR_ANGLE_REVERSE_ENUM
{
   MOTOR_ANGLE_NOT_REVERSE=0, /* Motor angle not reverse. | */
   MOTOR_ANGLE_REVERSE=1, /* Motor angle reverse. | */
   MOTOR_ANGLE_REVERSE_ENUM_ENUM_END=2, /*  | */
} MOTOR_ANGLE_REVERSE_ENUM;
#endif

/** @brief Motor force reverse control. */
#ifndef HAVE_ENUM_MOTOR_FORCE_REVERSE_ENUM
#define HAVE_ENUM_MOTOR_FORCE_REVERSE_ENUM
typedef enum MOTOR_FORCE_REVERSE_ENUM
{
   MOTOR_FORCE_NOT_REVERSE=0, /* Motor force not reverse. | */
   MOTOR_FORCE_REVERSE=1, /* Motor force reverse. | */
   MOTOR_FORCE_REVERSE_ENUM_ENUM_END=2, /*  | */
} MOTOR_FORCE_REVERSE_ENUM;
#endif

/** @brief Motor enable control. */
#ifndef HAVE_ENUM_MOTOR_ENABLE_ENUM
#define HAVE_ENUM_MOTOR_ENABLE_ENUM
typedef enum MOTOR_ENABLE_ENUM
{
   MOTOR_ENABLE_NOT=0, /* Motor not enabled. | */
   MOTOR_ENABLE=1, /* Motor enabled. | */
   MOTOR_ENABLE_ENUM_ENUM_END=2, /*  | */
} MOTOR_ENABLE_ENUM;
#endif

/** @brief Mode of light. */
#ifndef HAVE_ENUM_LIGHT_MODE
#define HAVE_ENUM_LIGHT_MODE
typedef enum LIGHT_MODE
{
   LIGHT_MODE0=0, /* None light mode. | */
   LIGHT_MODE1=1, /* Mode 1. | */
   LIGHT_MODE2=2, /* Mode 2. | */
   LIGHT_MODE3=3, /* Mode 3. | */
   LIGHT_MODE4=4, /* Mode 4. | */
   LIGHT_MODE5=5, /* None light mode. | */
   LIGHT_MODE6=6, /* Mode 1. | */
   LIGHT_MODE7=7, /* Mode 2. | */
   LIGHT_MODE8=8, /* Mode 3. | */
   LIGHT_MODE9=9, /* Mode 4. | */
   LIGHT_MODE_ENUM_END=10, /*  | */
} LIGHT_MODE;
#endif

/** @brief On/off of light. */
#ifndef HAVE_ENUM_LIGHT_ON_OFF
#define HAVE_ENUM_LIGHT_ON_OFF
typedef enum LIGHT_ON_OFF
{
   LIGHT_OFF=0, /* Off. | */
   LIGHT_ON=1, /* On. | */
   LIGHT_ON_OFF_ENUM_END=2, /*  | */
} LIGHT_ON_OFF;
#endif

/** @brief IMU open/close constant temperature. */
#ifndef HAVE_ENUM_IMU_CONSTANT_TEMPERATURE_ENUM
#define HAVE_ENUM_IMU_CONSTANT_TEMPERATURE_ENUM
typedef enum IMU_CONSTANT_TEMPERATURE_ENUM
{
   IMU_CONSTANT_TEMPERATURE_CLOSE=0, /* IMU constant temperature close . | */
   IMU_CONSTANT_TEMPERATURE_OPEN=1, /* IMU constant temperature open . | */
   IMU_CONSTANT_TEMPERATURE_ENUM_ENUM_END=2, /*  | */
} IMU_CONSTANT_TEMPERATURE_ENUM;
#endif

/** @brief Similar to MAV_TYPE, used to differentiate heartbeat device types. Dynamically adjusts target component IDs in CMD (target component ID must match the team ID in ACK to be recognized and unpacked by mavsdk).
            Reference official MAV_TYPE definition.
             */
#ifndef HAVE_ENUM_TK_DEVICE_TYPE
#define HAVE_ENUM_TK_DEVICE_TYPE
typedef enum TK_DEVICE_TYPE
{
   TK_GIMBAL=100, /* Gimbal device. | */
   TK_CAMERA=101, /* Camera device. | */
   TK_MOTOR=102, /* Motor device. | */
   TK_PUBLIC=103, /* Public device. | */
   TK_DEVICE_TYPE_ENUM_END=104, /*  | */
} TK_DEVICE_TYPE;
#endif

/** @brief Gimbal tracking status */
#ifndef HAVE_ENUM_TK_TRACK_STATUS
#define HAVE_ENUM_TK_TRACK_STATUS
typedef enum TK_TRACK_STATUS
{
   TK_NOT_TRACKING=0, /* Not tracking | */
   TK_TRACKING=1, /* Tracking | */
   TK_SEARCHING=2, /* Searching | */
   TK_TRACK_STATUS_ENUM_END=3, /*  | */
} TK_TRACK_STATUS;
#endif

/** @brief Gimbal working mode */
#ifndef HAVE_ENUM_TK_GIMBAL_MODE
#define HAVE_ENUM_TK_GIMBAL_MODE
typedef enum TK_GIMBAL_MODE
{
   TK_MODE_LOCK=0, /* Lock mode | */
   TK_MODE_YAW_FOLLOW=1, /* Yaw follow mode | */
   TK_GIMBAL_MODE_ENUM_END=2, /*  | */
} TK_GIMBAL_MODE;
#endif

/** @brief Peripheral device status flag */
#ifndef HAVE_ENUM_TK_PERIPHERAL_DEVICE_STATUS_FLAG
#define HAVE_ENUM_TK_PERIPHERAL_DEVICE_STATUS_FLAG
typedef enum TK_PERIPHERAL_DEVICE_STATUS_FLAG
{
   TK_VIDEO_RECORDING_STATUS=1, /* Video recording status, 0: not recording, 1: recording | */
   TK_DEVICE_LASER_LIGHT_STATUS=2, /* Laser light status, 0: off, 1: on | */
   TK_DEVICE_FILL_LIGHT_STATUS=4, /* Fill light status, 0: off, 1: on | */
   TK_DEVICE_LASER_RANGEFINDER_STATUS=8, /* Laser rangefinder status, 0: not measuring, 1: measuring | */
   TK_DEVICE_TARGET_RECOGNITION_STATUS=16, /* Target recognition status, 0: not recognizing, 1: recognizing | */
   TK_TRIGGER_STATUS=32, /* Trigger status, 0: not triggered, 1: triggered | */
   TK_ELECTRIC_LOCK_STATUS=64, /* Electric lock status, 0: locked, 1: unlocked | */
   TK_PERIPHERAL_DEVICE_STATUS_FLAG_ENUM_END=65, /*  | */
} TK_PERIPHERAL_DEVICE_STATUS_FLAG;
#endif

/** @brief Unitree dog basic action */
#ifndef HAVE_ENUM_UNITREE_DOG_BASIC_ACTION
#define HAVE_ENUM_UNITREE_DOG_BASIC_ACTION
typedef enum UNITREE_DOG_BASIC_ACTION
{
   UNITREE_DOG_ACTION_UNLOCK=0, /* Unlock | */
   UNITREE_DOG_ACTION_SIT_DOWN_UP=1, /* Sit / Stand | */
   UNITREE_DOG_ACTION_RECOVER=2, /* Self-right / Recover | */
   UNITREE_DOG_ACTION_LIGHT_SWITCH=3, /* Toggle lights | */
   UNITREE_DOG_ACTION_DANCE=4, /* Dance | */
   UNITREE_DOG_ACTION_JUMP=5, /* Jump | */
   UNITREE_DOG_BASIC_ACTION_ENUM_END=6, /*  | */
} UNITREE_DOG_BASIC_ACTION;
#endif
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_NOTIFY_FILE_UPDATE=50001, /* Notify audio file updated. |Update audio file type| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ENTER_DEV_MODE=50002, /* Enter developer mode. |password| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_UPDATE_FIRMWARE=50003, /* Update speaker firmware. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_RESTART=50004, /* Restart speaker. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_START_PLAY_AUDIO=50300, /* Start play audio. |Play audio mode| Storage ID (1 for first, 2 for second, etc.)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_SPEAKER_STOP_PLAY_AUDIO=50301, /* Stop play audio. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_REQUEST_STATUS=50302, /* Request speaker status. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_SET_VOLUME=50303, /* Set volume. |Volume level(in persentage)| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_REQUEST_INFORMATION=50304, /* Request speaker infomation. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_SET_ANGLE=50305, /* Set speaker pitch. |Roll angle (of surface). Range: -180..180 degrees. NAN or 0 means value not set. 0.01 indicates zero roll.| Pitch angle (of surface). Range: -90..90 degrees. NAN or 0 means value not set. 0.01 means zero pitch.| Yaw angle. NaN to use default heading. Range: -180..180 degrees.| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_SET_LIGHT_MODE=50306, /* Set speaker light mode. |Positive valuce is up, negative value is down, 0 value is center.| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_SET_LIGHT_ON_OFF=50307, /* Set speaker light on/off. |0 is off, 1 is on.| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_FOLLOW_GIMBAL=50308, /* Set speaker follow the gimbal. |0: no, 1: yes| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_MULTI_CONNECTION_OPERATION=50309, /* Multi connection operation. |Connection id.| Connection id.| Connection id.| Connection id.| Connection index.| Operation type.| Empty|  */
   MAV_CMD_SPEAKER_APPLY_FILE_OPERATION_PERMISSION=50310, /* File operation permission. |0 is release, 1 is get.| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_REAL_TIME_VOICE_OPERATION=50311, /* Speaker real time voice operation. |0 is start, 1 is stop.| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_SPEAKER_SET_CAMERA_NETWORK_PARAMS=50312, /* Set network params of camera |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_SPEAKER_GET_CAMERA_NETWORK_PARAMS=50313, /* Get network params of camera |IP byte 0| IP byte 1| IP byte 2| IP byte 3| Bitrate| Resolution| Encoding|  */
   MAV_CMD_SKYLINK_REQUEST_INFORMATION=50400, /* Request skylink infomation. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_LIGHT_REQUEST_INFORMATION=50500, /* Request light infomation. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_LIGHT_SET_MODE=50501, /* Set speaker light mode. |ID of light| Mode of light, total number is 10.| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_LIGHT_SET_ON_OFF=50502, /* Set speaker light on/off. |ID of light| 0 is off, 1 is on.| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_LIGHT_SET_BRIGHTNESS=50503, /* Set speaker light brightness. |ID of light|  Brightness of light.| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_LIGHT_REQUEST_STATUS=50504, /* Set speaker light on/off. |ID of light| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_TK_GIMBAL_REQUEST_INFORMATION=51000, /* Request custom gimbal infomation. |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_ENTER_UPGRADE_MODE=51031, /* Enter upgrade mode |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_EXIT_UPGRADE_MODE=51032, /* Exit upgrade mode |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_QUERY_GIMBAL_IP_ADDRESS=51033, /* Query IP address |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_QUERY_RC_CHANNELS=51034, /* Query rc channel data. |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_QUERY_GIMBAL_STD_FEEDBACK_INFO=51035, /* Query gimbal standard information. |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_QUERY_IMU_INFO=51036, /* Query IMU information. |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_SET_GIMBAL_MODE=51037, /* Set gimbal working mode |Gimbal working mode| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_CAMERA_CHANGE_PIP=51400, /* Change camera PIP |PIP mode| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_CAMERA_CHANGE_PSEUDO_COLOR=51401, /* Change camera pseudo color |pseudo color| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_CAMERA_OSD=51402, /* Set camera OSD |osd status| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_CAMERA_IMAGE_FLIP=51403, /* Set camera flip |flip status| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_CAMERA_ELECTRONIC_ZOOM=51404, /* Set camera electronic zoom |zoom status| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_CAMERA_ELECTRONIC_STABILIZATION=51405, /* Set camera electronic stabilization |camera electronic stabilization status| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_CAMERA_INFRARED_TEMPERATURE=51406, /* Infrared temperature measurement || Infrared temperature measurement status| Temperature measurement level| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_LASER_INDICATOR_LIGHT=51407, /* Laser indicator light |Laser indicator light status| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_LASER_RANGE_FINDER=51408, /* Laser range finder |Laser range finder flag| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_HUMAN_VEHICLE_DETECTION=51409, /* Human and vehicle detection |Human and vehicle detection status| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_FILL_LIGHT_CONTROL=51410, /* Fill light control |Fill light control flag| Fill light status| Fill light brightness  minValue = "0" maxValue = "255" | Fill light spot size minValue = "0" maxValue = "180"| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_CAMREA_PARAM_SAVE=51411, /* Save camera parameters |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_SWITCH_CAMERA_LENS=51412, /* Switch camera lens |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_READ_MOTOR_STATUS_1=51600, /* read motor status 1.  |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_CLEAR_MOTOR_ERR_SIGNS=51601, /* clear motor err signs.   |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_READ_MOTOR_STATUS_2=51602, /* read motor status 2.   |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_READ_MOTOR_STATUS_3=51603, /* read motor status 3.   |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_CLOSE_MOTOR=51604, /* Switch the motor from the enabled state.  |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_OPEN_MOTOR=51605, /* Switch the motor from disabled state to enabled state.  |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_STOP_MOTOR=51606, /* Stop the motor without clearing its running state. Motor can be controlled again by sending control commands.  |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_OPEN_LOOP_CONTROL=51607, /* Open loop control. |data type float, Range -850~850 (Motor current and torque varies by motor). | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_TORQUE_CLOSED_LOOP_CONTROL=51608, /* Torque closed-loop control. |data type float ,The torque current output value range of the motor is -2048~2048, corresponding to the actual torque current range of -16.5A~16.5A for MF motors and -33A~33A for MG motors. The bus current and actual torque vary by motor. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SPEED_CLOSED_LOOP_CONTROL=51609, /* speed closed-loop control. |Data type float, control the motor speed, the corresponding actual speed is 0.01dps/LSB. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_MULTI_TURN_POSITION_CLOSED_LOOP_CONTROL_1=51610, /* Multi-turn position closed loop control. | corresponding to actual position is 0.01degree/LSB, i.e. 36000 represents 360/deg. Motor rotation direction is determined by the difference between target position and current position. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_MULTI_TURN_POSITION_CLOSED_LOOP_CONTROL_2=51611, /* Multi-turn position closed loop contro2. |Data type float, control the motor speed, the corresponding actual speed is 0.01dps/LSB. | Control value maxSpeed limits the maximum motor rotation speed, float type, corresponding to actual speed 0.01dps/LSB. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SINGLE_TURN_POSITION_CLOSED_LOOP_CINTROL_1=51612, /* Single turn position closed loop control. |Motor rotation direction, see MOTOR_DIRECTION_CONTROL enum| Control value angleControl is float type, value range 0~35999, corresponding to actual position is 0.01degree/LSB, actual angle range 0°~359.99°| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SINGLE_TURN_POSITION_CLOSED_LOOP_CINTROL_2=51613, /* Single turn position closed loop control. |Motor rotation direction, see MOTOR_DIRECTION_CONTROL enum| Control value angleControl is float type, value range 0~35999, corresponding to actual position is 0.01degree/LSB, actual angle range 0°~359.99°| Control value maxSpeed limits the maximum motor rotation speed, float type, corresponding to actual speed 0.01dps/LSB. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_READ_CONTROL_PARAMETER=51614, /* Read control parameter. |The host sends this command to read the current motor control parameters. The parameter to read is determined by the ID controlParamID, see MOTOR_PARAMETER_CONTROL_TABLE.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_WRITE_CONTROL_PARAMETER=51615, /* Read control parameter. |The host sends this command to read the current motor control parameters. The parameter to read is determined by the ID controlParamID, see MOTOR_PARAMETER_CONTROL_TABLE.| param1. | param2. | param3. | param4. | param5. | param6. |  */
   MAV_CMD_MOTOR_READ_ENCODER=51616, /* Read control parameter. |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_SET_MOTOR_ZERO_POSITION=51617, /* Set motor zero position . |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_READ_MULTI_TURN_ANGLES=51618, /* Host sends this command to read the motor's current multi-turn absolute angle value.  |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_CLEAR_MOTOR_CYCLES=51619, /*  Host sends this command to clear the motor's current number of revolutions.  |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_READ_SINGLE_ANGLE=51620, /*   Host sends this command to read the motor's current multi-turn absolute angle value. |Empty| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SET_CUR_POSITION_TO_ANY_ANGLE=51621, /*  Host sends this command to set the motor's current position as any angle (multi-turn). The multi-turn angle value motorAngle is int32_t type data, with unit 0.01°/LSB. |Multi-turn angle value. |The multi-turn angle value motorAngle is float type data, with unit 0.01°/LSB.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SET_SYS_ID=51622, /* update motor sys id. |motor sys id.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SET_COMP_ID=51623, /* update motor comp id. |motor comp id.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_QUERY_ID=51624, /* Query motor comp id. |.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_FLASH_SAVE=51625, /* QFlash Parameter save. |.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_CALIBRATION=51626, /* motor calibration. |.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SET_CAN_ID=51627, /* Set motor CAN ID. |set motor can id.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_READ_CAN_ID=51628, /* Read motor CAN ID. |read motor can id.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_LINE_REVERSE=51629, /* Set motor line reverse. |Set motor line reverse, 0 is not reverse, 1 is reverse.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_ANG_REVERSE=51630, /* Set motor angle reverse. |Set motor angle reverse, 0 is not reverse, 1 is reverse.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_ZERO_CALIBRATION=51631, /* Set motor zero calibration. |Set current angle as zero offset| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_FORCE_REVERSE=51632, /* Force motor reverse. |Force motor reverse, 0 is not reverse, 1 is reverse.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_SELECT_DRIVE=51633, /* Select motor drive. |Select motor drive type| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_MOTOR_ENABLE=51634, /* Enable motor. |Enable motor, 0 is not enabled, 1 is enabled.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_WRITE_BOOT_STATION_TYPE=51800, /* Read boot station type. |read boot station type.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_TK_READ_BOOT_STATION_TYPE=51801, /* Read boot station type. |.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_SET_CAN_ID=51802, /* Set  CAN ID. |set  can id| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_READ_CAN_ID=51803, /* Read  CAN ID. |read  can id| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_IMU_CONSTANT_TEMPERATURE_STATE=51804, /* open / closed IMU. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_IMU_SET_CONSTANT_TEMPERATURE=51805, /* set imu constant temperature. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_IMU_SAVE_PARAMETER=51806, /* save imu parameter. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_IMU_READ_PARAMETER=51807, /* Read IMU parameter. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_IMU_HORIZONTAL_ALIGNMENT=51808, /* IMU horizontal alignment. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_IMU_ORIENTATION_ALIGNMENT=51809, /* IMU orientation alignment. || | | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_IMU_STATIC_CALIBRATION=51810, /* IMU static calibration,Calibration of the zero bias of angular velocity for IMU. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_SUBSCRIPTION_LOG_INFO=51811, /* Subscription log information. |Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_READ_IMU_PARAMETER=51812, /* read IMU parameter. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_CONTROL_SERVO=51813, /* contorl servo. || | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_CONTROL_CLUTCH=51814, /* control clutch. || | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_CONTROL_DATA_COLLECTION=51815, /* cotrol data collection. || Fill in the time, minute and second in Beijing Time.| Fill in the time, minute and second in Beijing Time.| Fill in the time, minute and second in Beijing Time.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_SUBSCRIBE_STRAIN_GAUGE_DATA=51816, /* Subscribe stram gauge data. || Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UPDATE_COLLECTION_FREQUENCY=51817, /* update collection frequency. | collection frequency. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_GAUGE_CALIBRATION=51818, /* Calibrate data collection gauge parameters. | calibration value , min = 0, max  = 4096 . | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_PLANE_PARAMS_SAVE=51819, /* Save data collection gauge parameters. | | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UNITREE_DOG_BASIC_MOVE_CONTROL=51900, /* Basic move control of Unitree Robotics Dog. | Left joystick X axis control, float type, range -1.0~1.0 |  Left joystick Y axis control, float type, range -1.0~1.0 |  Right joystick X axis control, float type, range -1.0~1.0 |  Right joystick Y axis control, float type, range -1.0~1.0 | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UNITREE_DOG_COMMON_KEY_CONTROL=51901, /* Common key control of Unitree Robotics Dog. | Key value to control.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UNITREE_DOG_UNLOCK=51902, /* Unlock Unitree Robotics Dog. | | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UNITREE_DOG_SIT_STAND_CONTROL=51903, /* Sit/Stand control of Unitree Robotics Dog. | Sit/Stand control. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_UNITREE_DOG_BASIC_ACTION_CONTROL=51904, /* Basic action control of Unitree Robotics Dog. | Basic action control, e.g., sit/stand, heart sign, dance, etc ,see UNITREE_DOG_BASIC_ACTION enum. | Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_ENUM_END=51905, /*  | */
} MAV_CMD;
#endif
...
#include "./mavlink_msg_log_information.h"
#include "./mavlink_msg_speaker_information.h"
#include "./mavlink_msg_speaker_status.h"
#include "./mavlink_msg_speaker_audio_info.h"
#include "./mavlink_msg_speaker_connection_status.h"
#include "./mavlink_msg_speaker_camera_network_params.h"
#include "./mavlink_msg_skylink_information.h"
#include "./mavlink_msg_skylink_file_information.h"
#include "./mavlink_msg_light_information.h"
#include "./mavlink_msg_light_file_information.h"
#include "./mavlink_msg_light_status.h"
#include "./mavlink_msg_tk_custom_data.h"
#include "./mavlink_msg_tk_gimbal_information.h"
#include "./mavlink_msg_tk_rc_channels.h"
#include "./mavlink_msg_tk_gimbal_std_feedback_information.h"
#include "./mavlink_msg_tk_imu_info.h"
#include "./mavlink_msg_tk_global_position.h"
#include "./mavlink_msg_tk_attitude.h"
#include "./mavlink_msg_tk_tracking_status.h"
#include "./mavlink_msg_tk_infrared_temperature.h"
#include "./mavlink_msg_tk_peripheral_device_status.h"
#include "./mavlink_msg_motor_status_info_1.h"
#include "./mavlink_msg_motor_status_info_2.h"
#include "./mavlink_msg_motor_status_info_3.h"
#include "./mavlink_msg_motor_parameter_info.h"
#include "./mavlink_msg_motor_encoder_info.h"
#include "./mavlink_msg_motor_encoder_zero_position_info.h"
#include "./mavlink_msg_motor_multiturn_angle_info.h"
#include "./mavlink_msg_motor_single_turn_angle_info.h"
#include "./mavlink_msg_motor_sys_comp_id_info.h"
#include "./mavlink_msg_motor_can_id_info.h"
#include "./mavlink_msg_boot_station_information.h"
#include "./mavlink_msg_can_id_info.h"
#include "./mavlink_msg_imu_info.h"
#include "./mavlink_msg_ip_address_info.h"
#include "./mavlink_msg_tk_log_info.h"
#include "./mavlink_msg_tk_strain_gage_data_collection.h"
#include "./mavlink_msg_unitree_dog_joystick.h"
